...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      // 👇 新增音乐页面路由（复制这段代码）
      {
        path: 'music', // 路由路径（完整路径为 /index/music）
        name: 'musicView', // 路由名称（和导航栏的 active 判断一致）
        component: () => import('/@/views/index/MusicView.vue') // 音乐页面组件路径
      },
      {
        path: 'portal',
        name: 'portal',
      ...
      },
      {
        path: 'couponCenter',
        name: 'couponCenter',
        component: () => import('/@/views/index/coupon-center.vue')
      },
      {
        path: 'usercenter',
        name: 'usercenter',
        ...
        children: [
          ...
          },
          {
            ...
            name: 'userCouponsView',
            component: () => import('/@/views/index/user/UserCoupons.vue')
          },
          {
            path: 'orderView',
            name: 'orderView',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'coupon', name: 'coupon', component: () => import('/@/views/admin/coupon.vue') },
